...
const TIPO_CFG = {
  "Network Rollout":        {c:"#2563EB",bg:"#EFF6FF",bdr:"#BFDBFE",label:"Network Rollout",abv:"NRO"},
  "Network Modernization":  {c:"#D97706",bg:"#FFFBEB",bdr:"#FDE68A",label:"Network Modernization",abv:"MOD"},
  "Capacity Expansion":     {c:"#059669",bg:"#ECFDF5",bdr:"#A7F3D0",label:"Capacity Expansion",abv:"CAP"},
  "Customer Investment":    {c:"#E8182A",bg:"#FFF1F1",bdr:"#FDD8DA",label:"Customer Investment",abv:"CUI"},
  "Enterprise & Wholesale": {c:"#7C3AED",bg:"#F5F3FF",bdr:"#DDD6FE",label:"Enterprise & Wholesale",abv:"ENT"},
  "Regulatory & Spectrum":  {c:"#B45309",bg:"#FFFBEB",bdr:"#FCD34D",label:"Regulatory & Spectrum",abv:"REG"},
  "IT & Digital":           {c:"#0891B2",bg:"#ECFEFF",bdr:"#A5F3FC",label:"IT & Digital",abv:"ITD"},
  "Network Operations":     {c:"#6B7280",bg:"#F9FAFB",bdr:"#E5E7EB",label:"Network Operations",abv:"NOP"},
  RED:           {c:"#2563EB",bg:"#EFF6FF",bdr:"#BFDBFE",label:"Network Rollout",abv:"NRO"},
  CLIENTE:       {c:"#E8182A",bg:"#FFF1F1",bdr:"#FDD8DA",label:"Customer Investment",abv:"CUI"},
  IT:            {c:"#0891B2",bg:"#ECFEFF",bdr:"#A5F3FC",label:"IT & Digital",abv:"ITD"},
  ADMINISTRATIVA:{c:"#6B7280",bg:"#F9FAFB",bdr:"#E5E7EB",label:"Network Operations",abv:"NOP"},
};
